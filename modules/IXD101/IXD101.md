...
Today we'll look at an introduction to HTML (HyperText Markup Language), by first taking a look back through the past 26 years of the world wide web, from it's humble beginnings in 1989, when inventor Sir Tim Berners-Lee produced the original proposal for the web to what it has become today.
