...
To help embed what we covered today I would like you to take the [brief-history-of-type.txt](resources/brief-history-of-type.txt) from GitHub and mark it up to match the [image provided](resources/html-01-make-this.png). Add this to your Baskerville Repo under a separate heading **History of Type**.
