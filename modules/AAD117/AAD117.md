...
Adding the links to let you get started, I will add content soonest.

###Style Tiles
When you provide detailed mockups of a website, digital publication or brochure, you can easily imply that you’re executing the final design. Clients can quickly get confused and feel disconnected from the design process. This can give them a false sense of completion, detaching them from the final solution. 

Managing your clients expectations and involving them in the development of the deliverables will make them feel a more active part of the whole process and help buy-in on the design proposals.

The creation of a series of [Style Tiles](http://styletil.es) at the early part of the process can help define the general visual approach of the project and, unlike website mockups, are relatively easy and quick to create.

[Typecast](http://typecast.com) is an excellent way to quickly prototype the typographic layout of your website. Sign up for a free account as soon as you can.

###Pattern Libraries

Pattern Libraries such as those created by [MailChimp](http://ux.mailchimp.com/patterns), have become an essential asset to many of today’s major organiations. They can help ensure consistency in user experience, allow for reusability of frequently used elements and help make site maintenance a much easier process. 

A List Apart have a useful little feature – [Getting Started with Pattern Libraries](http://alistapart.com/blog/post/getting-started-with-pattern-libraries)

Gimmebar have an excellent resource of [Front end styleguides and pattern libraries](https://gimmebar.com/collection/4ecd439c2f0aaad734000022/front-end-styleguides)
...
####Recommended Reading
- Per Mollerup’s [Marks of Excellence](http://www.amazon.co.uk/Marks-Excellence-History-Taxonomy-Trademarks/dp/0714864749/ref=sr_1_1?ie=UTF8&qid=1428926988&sr=8-1&keywords=Marks+of+Excellence) is, an excellent introduction to the history and development of many of the iconic brands we still see today.
...
- David Airey’s [Logo Design Love](http://www.amazon.co.uk/Logo-Design-Love-Creating-Identities/dp/0321985206/ref=sr_1_2?ie=UTF8&qid=1428927574&sr=8-2&keywords=Designing+Brand+Identity) is an excellent introduction to creating brands, looking at best practices for extending a logo to the development of a complete brand identity system.
