...
---
# Module Hand In: Thursday 11th May 2017 at 12:00

Remember to put links to all deliverables one post for the module on your tumblr blogs.  

## Deliverables

- Illustrative (40%)
	- Master Apprentice 01 + 02 / Icons and Cityscape
	- Travel App Design
	- Splash, Pick a City, City Detail
		
- Diagrammatic (40%)
	- 	Master Apprentice 03 + 04 / Pie Chart and Bar Chart
	- Population infographic. This could be: - World Population - Ageing Population - Population per country - Birth or Death Rate - Population by religion.  This infograhic should consider, layout, typography, charts, illustration.

- Research (20%): Tumblr Blog, Sketchbooks and Supporting Material
...
+ __Week 09:__ Designing Infographics 
+ __Week 10:__ A Cornucopia of Charts
...
### Week 08: Visualising Data 

__24 March, 2017__

This week we kicked off with the second and final set of content for the module, exploring visualising data.
...
- [How Different Groups Spend Their Day](http://www.nytimes.com//interactive/2009/07/31/business/20080801-metrics-graphic.html?hp)
- [The New York Times Innovation Portfolio](innovate.whsites.net)

### Master Apprentice 04
Remake a pie chart - using sketch or illustrator.  You can choose either this [image](https://www.dropbox.com/s/t34ert3dq4y223n/pie-bar.png?dl=0) or this [image](https://www.dropbox.com/s/13k8ip6o18rts2u/pie-chart.png?dl=0).
...
This week we look at a designing infographics through:

1. The death of words
2. Rise of Infographic
3. Tools 

We will look at a range of infographics for inspiration.  


### Master Apprentice 04
Remake a Bar chart - using sketch or illustrator.  You can choose either this [image](https://www.dropbox.com/s/we9lvnm4had0u6m/bar_chart.png?dl=0) or this [image](https://www.dropbox.com/s/ob5cigbikcurao6/kylescollin-barchartslide-1.png?dl=0).

Extra credit for doing extra bar charts.

#### URLs
+ [6 Dos and Donts of Designing Inforgraphics](https://medium.com/eastwick-digital-marketing/6-dos-and-donts-for-designing-infographics-that-work-e332931e3b6d#.d3qyapsd7)
+ [The difference between infographics and data visualisation](https://dapresy.com/difference-between-infographics-and-data-visualization/)
+ [Infographic Inspiration](http://www.siegemedia.com/creation/best-infographics)
...
Today we will go over what we have covered over the last 10 weeks.

We will look at the history of data visualisation from ancient times, how we visualise the world and ourselves.  

We will also cover a little history of charts in the past and how they were used.  We will look at the different types of charts out there today.  
...
#### App Mockup Screens (Too make your work look awesome.)

+[iPhone 6 - Illustrator Download by Dave Stadler - Dribbble](https://dribbble.com/shots/1719083-iPhone-6-Illustrator-Download)
+ [iPhone 6 Psd Vector Mockup | Psd Mock Up Templates | Pixeden](http://www.pixeden.com/psd-mock-up-templates/iphone-6-psd-vector-mockup)
+ [iPhone 6 flat mockup by Senya Ars - Dribbble](https://dribbble.com/shots/1722786-iPhone-6-flat-mockup)
+ [Free PSD iPhone 6 Mockups - graphberry.com](http://www.graphberry.com/item/free-iphone-6mockups/)
+  [Free iPhone Perspective App Screen Mockup | ZippyPixels](http://zippypixels.com/product/mockups/perspective/free-iphone-perspective-app-screen-mockup/)
----
...
- [China](http://pin.it/5O_jeIf)
- [By Catch](http://pin.it/AW8EhoL)
- [Mankind](http://pin.it/VGcgmpV)
- [Ageing](http://pin.it/yA-dAjr)
- [Syrian Refugees](http://pin.it/s7km60V)
- [Ageing Population 2](http://pin.it/LADmx6e)
- [Population](http://pin.it/nYZznK2)
...
A more detailed breakdown of the assessment, with deliverables, is available [here](https://github.com/ixdbelfast/ixdbelfast.github.io/blob/master/modules/IXD104/Module-IXD104:DES107-Deliverable-Breakdown.md).
