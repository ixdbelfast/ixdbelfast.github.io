...
Following on from last week's introduction to Web Fonts, using your typographic choices from your style tiles, we'd like to see you add web fonts to the Bird text you marked up in week 2.

We'd like to see a range of examples with commentary on what works and what doesn't and evidence your understanding of appropriate typography (Why is comic sans not an appropriate font choice for a funeral parlour?)

__Lab Resources__
+ [Google Fonts](https://www.google.com/fonts)
+ [Typekit](https://typekit.com/)
+ [Fotn Squirrel](http://www.fontsquirrel.com/)
