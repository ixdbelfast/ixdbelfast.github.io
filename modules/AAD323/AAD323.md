...
+ Email: __p.mccormack@ulster.ac.uk__
...
You will be expected to submit the following components:

+ Digital Product and Promotional Website (Linked from Design Journal)
+ Digital Product Project Proposal (Keynote/Powerpoint Slides)
+ Reflective Design Journal (Including research and experimentation)

###When and where is the final submission?

+ Date: __Wednesday 6th May__
+ Time: __12:00pm__
...
Questions? Contact: [Paul McCormack](mailto:p.mccormack@ulster.ac.uk?Subject=DES311).
