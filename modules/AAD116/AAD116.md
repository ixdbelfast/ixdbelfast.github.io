...
[Tim Brown][7] has created a very useful online [Modular Scale][8] which will help you – once you get to grips with CSS – to develop a well controlled balance to the typography on your Design Journal. Jeremy Church’s [Type Scale](http://type-scale.com) as a very easy visual dimension to it. What’s more you can grab the CSS from here and add it to your own site.
